...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def _should_process_message(self, message: Message, *, is_command: bool = False) -> bool:
        ...
        facts = RoutingFacts(
            ...
            mentions_other=self._message_mentions_other_handle(message),
            contains_other_handle=self._message_contains_handle_token(message),
            replies_to_self=self._is_reply_to_bot(message),
            replies_to_other_bot=self._is_reply_to_other_bot(message),
